...
public class ProductCatalogRepository {
    ...
    public List findAll(int count) {
        return sessionFactory.getCurrentSession().createQuery("from ProductCatalogItem", ProductCatalogItem.class)
                .setMaxResults(count)
                .list();
    }
    ...
    public List findByProductName(String str, int count) {
        return sessionFactory.getCurrentSession()
